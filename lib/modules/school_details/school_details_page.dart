                                  ...
                                  WonderEditorialScreen(
                                      WonderData(
                                        ...
                                        title: schoolController
                                            .schoolDetailsModel!.school.name!,
                                        subTitle: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .schoolType,
                                        regionTitle:
                                            "${schoolController.schoolDetailsModel!.school.city} ${schoolController.schoolDetailsModel!.school.state}",
                                        photo1: schoolController
                                            .schoolDetailsModel!.school.photo1,
                                        photo2: schoolController
                                            .schoolDetailsModel!.school.photo2,
                                        photo3: schoolController
                                            .schoolDetailsModel!.school.photo3,
                                        headerPhoto: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .headerImageUrl,
                                        startYr: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .startYear,
                                        endYr: schoolController
                                            .schoolDetailsModel!.school.endYear,
                                        artifactStartYr: 1600,
                                        artifactEndYr: 1700,
                                        artifactCulture: AppStrings()
                                            .tajMahalArtifactCulture,
                                        artifactGeolocation: AppStrings()
                                            .tajMahalArtifactGeolocation,
                                        lat: 27.17405039840427,
                                        lng: 78.04211890065208,
                                        unsplashCollectionId: '684IRta86_c',
                                        pullQuote1Top: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .pullQuote1Top,
                                        pullQuote1Bottom: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .pullQuote1Bottom,
                                        pullQuote1Author: '',
                                        pullQuote2: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .pullQuote2,
                                        pullQuote2Author: AppStrings()
                                            .tajMahalPullQuote2Author,
                                        callout1: AppStrings().tajMahalCallout1,
                                        callout2: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .callout2,
                                        videoCaption: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .videoCaption,
                                        videoId: schoolController
                                            .schoolDetailsModel!.school.videoId,
                                        mapCaption: "",
                                        historyInfo1: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .description,
                                        historyInfo2: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .historyInfo2,
                                        constructionInfo1: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .constructionInfo1,
                                        constructionInfo2: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .constructionInfo2,
                                        locationInfo1: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .locationInfo1,
                                        locationInfo2: schoolController
                                            .schoolDetailsModel!
                                            .school
                                            .locationInfo2,
