...
class PostDetailsPage extends StatelessWidget {
  ...
  Container getComments(PostDetailController postDetailController){
    return Container(
      ...
      child:  postDetailController.isCommentsLoading.value ?
      ...
      : Column(
        children: [
          ListView.builder(
            ...
            return Card(
              child: Padding(
                ...
                // Circular Profile Image
                CircleAvatar(
                  backgroundImage: NetworkImage(postDetailController.comments![index].profilePic),
                  radius: 20.0,
                ),
                SizedBox(width: 10.0),
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: "@${postDetailController.comments![index].user}", style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(text: postDetailController.comments![index].content)
                          ],
                        ),
                      ),
                      SizedBox(height: 5.0),
                      // Comment date
                      Text(
                        AppUtils.timeAgo(postDetailController.comments![index].createdAt),
          ...
          TextButton(onPressed: postDetailController.getComments, child: Text("Load More"))
        ],
      ),
    );
  }
