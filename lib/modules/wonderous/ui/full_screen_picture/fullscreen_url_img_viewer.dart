...
//   const FullscreenUrlImgViewer({super.key
//   // , required this.urls, this.index = 0
//   });
...
//       _controller.animateToPage(page, duration: Duration(milliseconds: 300), curve: Curves.easeOut);
//     }
//   }
...
//     content = Semantics(
//       label: 'FullScreenImageViewSemanticFull', //$strings.fullscreenImageViewerSemanticFull,
//       container: true,
//       image: true,
...
//                             semanticLabel:  'Next',//$strings.semanticsNext(''),
//                           ),
//                           Gap(
//                             // $styles.insets.xs
//                             10
