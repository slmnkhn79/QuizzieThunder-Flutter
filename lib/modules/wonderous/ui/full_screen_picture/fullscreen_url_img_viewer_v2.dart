...
class FullscreenUrlImgViewerV2 extends StatelessWidget {
  FullscreenUrlImgViewerV2({super.key, required this.galleryHeaderController,  required this.headerImageUrl});
  final GalleryHeaderController galleryHeaderController;
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      if( galleryHeaderController.galleryDetailsResponseModel!.eventDetails.isEmpty){
       ...
       {
        urls = galleryHeaderController.galleryDetailsResponseModel!.eventDetails.map((e) => e.imageUrl).toList();
        return getDisplay(urls);
