...
class DiagonalTextPageIndicator extends StatelessWidget {
  ...
  final int current;
  final int total;
  static final _fontSize = 26 * AppStyle().scale;

  @override
  Widget build(BuildContext context) {
    final textStyle = AppStyle().text.titleFont.copyWith(fontSize: _fontSize, height: 1);
            ...
            child: Transform.translate(
              ...
              child: SizedBox(
                ...
                child: Opacity(
                  ...
                  child: Text(
                    '0$total',
                    style: textStyle, //.copyWith(shadows: AppStyle().shadows.textStrong),
                  ),
                ),
              ),
            ),
