...
Widget _buildIcon(BuildContext context, AppIcons icon, {required bool isSecondary, required double? size}) =>
    AppIcon(icon, color: isSecondary ? AppStyle().colors.black : AppStyle().colors.offWhite, size: size ?? 18);
...
class AppBtn extends StatelessWidget {
    ...
    _builder = (context) {
      ...
      Text? txt = text == null
          ...
          : Text(text.toUpperCase(),
              style: AppStyle().text.btn, textHeightBehavior: TextHeightBehavior(applyHeightToFirstAscent: false));
  ...
  Widget build(BuildContext context) {
    Color defaultColor = isSecondary ? AppStyle().colors.white : AppStyle().colors.greyStrong;
    Color textColor = isSecondary ? AppStyle().colors.black : AppStyle().colors.white;
    ...
    OutlinedBorder shape = circular
        ...
        : RoundedRectangleBorder(side: side, borderRadius: BorderRadius.circular(AppStyle().corners.md));
              ...
              child: IgnorePointer(
                child: Container(
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppStyle().colors.accent1, width: 3))),
              ),
            )
        ],
      ),
