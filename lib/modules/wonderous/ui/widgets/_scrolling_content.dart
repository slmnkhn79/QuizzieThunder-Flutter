...
class _ScrollingContent extends StatelessWidget {
  const _ScrollingContent(this.data,
      {super.key, required this.scrollPos, required this.sectionNotifier});
  ...
  Widget build(BuildContext context) {
    Widget buildText(String value) =>
        Focus(child: Text(_fixNewlines(value), style: AppStyle().text.body));
        ...
        child: ExcludeSemantics(
          child: !skipCaps
              ? DropCapText(
                  ...
                  dropCap: DropCap(
                    width: dropCapWidth,
                    height: AppStyle().text.body.fontSize! *
                        AppStyle().text.body.height! *
                        2,
                ...
                child: Column(children: [
                  ..._contentSection([
                    ...
                    _CollapsingPullQuoteImage(
                        data: data, scrollPos: scrollPos), //done
                  ...
                  ..._contentSection([
                    ...
                    _LargeSimpleQuote(
                        text: data.pullQuote2,
                        author:
                            // data.pullQuote2Author
                            ""),
        ...
        child: Column(
          children: [
            ...
            Semantics(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: AppStyle().insets.md),
                child: Text(widget.data.mapCaption,
                    style: AppStyle().text.caption),
              ),
            ),
          ],
        ),
