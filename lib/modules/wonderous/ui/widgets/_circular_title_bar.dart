    ...
    return Transform.translate(
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
            // Bg
            BottomCenter(child: Container(height: barSize - barTopPadding, color: AppStyle().colors.offWhite)),
            ...
            BottomCenter(
              child: Padding(
                ...
                child: Image.asset('${ImagePaths.common}/${icons[index]}').animate(key: ValueKey(index)).fade().scale(
                    begin: Offset(.5, .5), end: Offset(1, 1), curve: Curves.easeOutBack, duration: AppStyle().times.med),
              ),
            ),
          ],
        ),
...
class _AnimatedCircleWithTextState extends State<_AnimatedCircleWithText> with SingleTickerProviderStateMixin {
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        ...
        return Transform.rotate(
          ...
          child: Container(
            decoration: BoxDecoration(shape: BoxShape.circle, color: AppStyle().colors.offWhite),
  ...
  Widget _buildCircularText(String title) {
    final textStyle = AppStyle().text.monoTitleFont.copyWith(
      fontSize: 22 * AppStyle().scale,
