  ...
  Widget build(BuildContext context) {
    ...
    TextSpan buildTextSpan(String text) {
      ...
      return TextSpan(
        ...
        style: useSmallText ? textStyle.copyWith(fontSize: 20 * AppStyle().scale) : textStyle,
      );
    }

    List<Shadow> shadows = enableShadows ? AppStyle().shadows.textSoft : [];
