...
import 'package:quizzie_thunder/modules/wonderous/ui/utils/page_routes.dart';
import 'package:quizzie_thunder/styles/styles.dart';
// import 'package:quizzie_thunder/modules/wonderous/ui/common/modals/fullscreen_video_viewer.dart';
// import 'package:quizzie_thunder/modules/wonderous/ui/common/utils/page_routes.dart';
...
class AppLogic {
  ...
  Future<void> bootstrap() async {
    ...
    if (PlatformInfo.isDesktop) {
      await DesktopWindow.setMinWindowSize(AppStyle().sizes.minAppSize);
    }
